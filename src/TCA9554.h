...
class TCA9534 : public TCA9554 { public: TCA9534(uint8_t address, TwoWire *wire = &Wire); };
class PCA9554 : public TCA9554 { public: PCA9554(uint8_t address, TwoWire *wire = &Wire); };
class PCA9534 : public TCA9554 { public: PCA9534(uint8_t address, TwoWire *wire = &Wire); };
class CAT9554 : public TCA9554 { public: CAT9554(uint8_t address, TwoWire *wire = &Wire); };
class CAT9534 : public TCA9554 { public: CAT9534(uint8_t address, TwoWire *wire = &Wire); };
